...
# Function to capture audio input and transcribe it
def capture_audio():
...
# Streamlit interface
st.title("LLM-Powered xTB Energy Calculator with Voice Input")

# Button to capture audio input
if st.button("Capture Audio Input"):
    user_input = capture_audio()
else:
    # Fallback text input in case user prefers typing
